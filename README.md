...
**Testgram fork:** the `dev` branch is preconfigured for the [50bar](https://github.com/CyberoniOntoni/testgram/blob/dev/deploy/DEPLOYMENT-50bar.md) server (`154.211.187.131`, MTProto `20443`–`20643`). See **[docs/BUILD-50bar.md](docs/BUILD-50bar.md)** for Windows build steps and login checklist.
