...
const BuiltInDc kBootstrapDcs[] = {
	{ 1, nullptr, FamilyGram::kBootstrapPortDc1 },
	{ 2, nullptr, FamilyGram::kBootstrapPortDc2 },
	{ 3, nullptr, FamilyGram::kBootstrapPortDc3 },
};
...
void DcOptions::constructFromBuiltIn() {
	...
	const auto host = BootstrapServerHost();
	const auto list = gsl::make_span(kBootstrapDcs);
	for (const auto &entry : list) {
		const auto flags = Flag::f_static | 0;
		applyOneGuarded(entry.id, flags, host, entry.port, {});
